...
<div style="background-color: #2d3748; border-radius: 0px; padding: 24px; margin: 20px 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
...
<a href="https://drive.google.com/uc?export=download&id=1GIUlthElBRDkEDTYf6zcMivwp2_lytUu" 
   style="display: inline-block; padding: 12px 24px; background-color: #4285F4; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-family: sans-serif; transition: background-color 0.2s;">
   📥 Download Alpha Version (Google Drive)
</a>
</div>
