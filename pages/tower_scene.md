...
> Please, read [Loading scenes](pages/loading_scenes.md) first <br>
> Also, read how to fill [tower config](pages/towersconfig.md) first
...
So to create tower add to the root `baseLuaClass`(string) metafield and write here your tower lua class.
