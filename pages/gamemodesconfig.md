...
```json
{
    "Standard": {
        ...
        "LoadingManagerClass": "StandardLoadingManager",
        "Modifiers": {
            "SplitRewards": {
                "Type": "bool",
                "Name": "Split Rewards",
...
- **LoadingManagerClass** - Name of the lua class that runs when game starts with this mode  
...
Add your gamemodes config to any subfoler of `Configs/Gamemodes`
